...
<<<<<<< HEAD
    // Interval countdown function here
=======
>>>>>>> 5eda9de186be2930d0641cdad1d0fb20c3b2615a
    countdown: function () {
        this.counter--;
...
<<<<<<< HEAD
    ...
    loadQuestion: function () {
        ...
        for (var i = 0; i < questions[this.currentQuestion].answers.length; i++) {
            ...
            card.append("<br><button class='answer-button' id='button' data-name='" + questions[this.currentQuestion].answers[i]
